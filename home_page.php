...
<li class="nav-item active"> <a class="nav-link" href ="./index.html"><spsn>Home</a></li>
<li > <a class="nav-link" href ="./index.html"><spsn>Stays</a></li>
<!--Navbar MENU-->
<li class="nav-item"> <a class="nav-link" href ="./aboutus.html"><spsn>About</a></li>
<li class="nav-item"> <a class="nav-link" href ="#"><spsn >Contact</a></li>
<li class="nav-item"> <a class="nav-link" href ="#"><spsn>Login</a></li>
...
<option value ="JOD" >JD</option>
    ...
    <div class="container">
        <div class="row row-content">
           ...
           <!--Scrolling Wrapper-->
            <div class="scrolling-wrapper " >
             ...
             <img class="img_item" src ="images/ajloun.png"></div>
             <div class="item">
             <div class ="text-center">AL- Balqaa'</div>
             <img class="img_item" src ="images/balqa.png"></div>
             <div class="item">
             <div class ="text-center">Dead Sea</div>
             <img class="img_item" src ="images/dead sea.png"></div>
             <div class="item">
             <div class ="text-center">Irbid </div>
             <img class="img_item" src ="images/irbid.png"></div>
             <div class="item">
             <div class ="text-center">Jarash</div>
             <img class="img_item" src ="images/jarash.png"></div>
             <div class="item">
             <div class ="text-center">AL-Karak</div>
             <img class="img_item" src ="images/karak.png"></div>
             <div class="item">
             <div class ="text-center">Madaba</div>
             <img class="img_item" src ="images/madaba.png"></div>
             <div class="item">
             <div class ="text-center">AL-Tafila</div>
             <img class="img_item" src ="images/tafila.png"></div>
             <div class="item">
             <div class ="text-center">Wadi Rum</div>
             <img class="img_item" src ="images/rum.png"></div>
             <div class="item">
        ...
        <div id ="alsaltOffer">
         ...
         <button type="button" class="btn btn-secondary" title="" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-bs-original-title="Popover Title" aria-describedby="popover576452">Details</button></div>
        </div>
