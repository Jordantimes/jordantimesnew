      ...
      <div class="container-fluid flex-container">
        ...
        <div id="myTabContent" class="tab-content">
          ...
          <div class="tab-pane fade " id="dashboard">
            <?php
            //==================================
            // This is backend created post
            // You should repeat this the way you want
            //======================================
            ...
            <div class="modal-content">
              ...
              <form action="company_page.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input name="editImg_file" multiple class="form-control" type="file" id="formFile">
                </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="company_page.php" method="POST">
                  ...
                  <div class="form-group">
                    <label for="formFile" class="form-label mt-4">Upload your images</label>
                    <input name="img_file" multiple class="form-control" type="file" id="formFile">
                  </div>
...
// This is backend from here
// change this to your  way 
