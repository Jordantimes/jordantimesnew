...
<li class="nav-item"> <a class="nav-link" href ="#"><spsn>Logout</a></li>
...
<body>
  ...
  <div class="container-fluid flex-container">
    <h2> username<?php  session_start();  echo $_SESSION['Name'] ?></h2>
  <ul class="nav nav-tabs flex-column flex-child">
    ...
    <li><a class="w-25 p-3 text-danger" data-toggle="tab" href="#notiifications">Notifications </a></li>
  </ul>
  ...
  <?php
      $sql2 = "select title, descriptions, images,price from trips";
  ...
  <div id=\"createdCard\" class=\"col-md-6 col-sm-6 my-6 my-md-0 \" >
              <form action=\"home\"  method=\"post\">
                  <div class=\"card shadow\">
                      <div>
                          <img src=\" $row[2]\" alt=\"Image1\" class=\"img-fluid card-img-top\">
                      </div>
                      <div class=\"card-body\">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <label for="exampleInputText" class="form-label mt-4">Campagin-ID</label>
              <input type="text" name="no" class="form-control" id="exampleInputText" aria-describedby="textHelp" placeholder="Enter Campagin Title">
        ...
        <div class="modal-footer">
        <button type="submit"  data-dismiss="modal" name="saveChanges" class="btn btn-primary">Save changes</button>
...
$sql = "INSERT INTO `trips` ( id, title, descriptions, images, price) VALUES
 (null, '$title', '$description', '$image_file', '$price')";
...
if (isset($_POST['editChanges'])){
  ...
  $sql = "Update `trips` set id, title, descriptions, images, price) VALUES
   (null, '$title', '$description', '$image_file', '$price')";
