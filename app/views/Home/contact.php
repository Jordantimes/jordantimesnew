...
<head>
    ...
    <link rel="stylesheet" type="text/css" href= <?php echo URLROOT."\public\CSS\contact.css";?>>
</head>
<body>
    <div class="main_view">
        ...
        <div class="content">
            <div class="contact_us_content">
                ...
                <div class="contact_details_container">
                    <div class="phone_box_wrapper">
                        <div class="contact_box">
                            <div class="contact_box_upper">
                                ...
                                <div class="contact_label_wrapper">
                                    <h3>Mobile phone</h3>
                                </div>
                            </div>
                    ...
                    <div class="contact_box_mail">
                        ...
                        <div class="contact_data_wrapper">
                            <h3><a class="mail_link" href="mailto:office@mail.com">office@mail.com</a></h3>
                        </div>
                    </div>
                </div>
            </div>
