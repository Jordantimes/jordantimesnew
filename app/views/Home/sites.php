            ...
            <div class="filter_section_wrapper">
                    <div class="main_trip_values_section">
                        <div class="input_wrapper" id="passenger_input_wrapper">
                            <button class="value_holder" id="passenger_count_holder">
                                ...
                                <div class="holder_text">
                                    <span class="passenger_counter">-</span> 
                                    Passenger(s)
                                </div>
                            ...
                            <div class="holder_select_list" id="passsenger_count_list" visibility="hidden">
                                <div class="options_wrapper">
                                    <div class="passenger_option" id="option">
                                        <button class="passenger_click" id="option_click">
                                            <label>
                                                1 Passenger
                                            </label>
                                        </button>
                        ...
                        <div class="input_wrapper" id="date_input_wrapper">
                            <button class="value_holder" id="trip_date_holder">
                                <div class="holder_icon">
                            ...
                            <div class="holder_select_list" id="trip_date_list" visibility="hidden" calender_type="start">
                                <div class="calender_container">
                                    ...
                                    <div class="nav_month_container">
                                        <button class="month_nav_left_wrapper">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="451.847px" height="451.847px" viewBox="0 0 451.847 451.847" style="enable-background:new 0 0 451.847 451.847;" xml:space="preserve">
                                                <g>
                                                    <path d="M225.923,354.706c-8.098,0-16.195-3.092-22.369-9.263L9.27,151.157c-12.359-12.359-12.359-32.397,0-44.751   c12.354-12.354,32.388-12.354,44.748,0l171.905,171.915l171.906-171.909c12.359-12.354,32.391-12.354,44.744,0   c12.365,12.354,12.365,32.392,0,44.751L248.292,345.449C242.115,351.621,234.018,354.706,225.923,354.706z"/>
                                                </g>
                                        ...
                                        <button class="month_nav_right_wrapper">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="451.847px" height="451.847px" viewBox="0 0 451.847 451.847" style="enable-background:new 0 0 451.847 451.847;" xml:space="preserve">
                                                <g>
                                                    <path d="M225.923,354.706c-8.098,0-16.195-3.092-22.369-9.263L9.27,151.157c-12.359-12.359-12.359-32.397,0-44.751   c12.354-12.354,32.388-12.354,44.748,0l171.905,171.915l171.906-171.909c12.359-12.354,32.391-12.354,44.744,0   c12.365,12.354,12.365,32.392,0,44.751L248.292,345.449C242.115,351.621,234.018,354.706,225.923,354.706z"/>
                                                </g>
                ...
                <form class="filter_form" action="#" method="GET">
                    <input id="passenger_radio" type="radio" name="passenger_count" value="1">
                    <input id="passenger_radio" type="radio" name="passenger_count" value="2">
                    <input id="passenger_radio" type="radio" name="passenger_count" value="3">
                    <input id="passenger_radio" type="radio" name="passenger_count" value="4">
                    <input id="passenger_radio" type="radio" name="passenger_count" value="5">
                    <input id="passenger_radio" type="radio" name="passenger_count" value="6">
