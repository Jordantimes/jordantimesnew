                        ...
                        <div class="profile_content">
                            <div class="profile_left_content">
                                <form action="<?php echo URLROOT;?>/Company/edit_profile" method="POST" enctype="multipart/form-data">
                                    <label class="data_label">Profile picture</label>
                                    <div class="profile_image_container">
                                        <div class="profile_image">
                                            <img class="profileIMG" src="<?php echo URLROOT."/public/images/users/companys/".$USER["Image"];?>" alt="Profile picture">
                                        </div>
                                    ...
                                    <div class="data_wrapper">
                                        ...
                                        <div class="data_div" name='name'><?php echo $USER["Name"]?></div>
                                    </div>
                                    ...
                                    <div class="data_wrapper_textarea">
                                        <label class="data_label">Bio</label>
                                            <?php
                                            if(!empty($USER["Bio"])){?>
                                                <div class="data_div_textarea"><?php echo nl2br($USER["Bio"])?></div>
                                            <?php }
                                            else{?>
                                    ...
                                    <div class="data_wrapper">
                                        ...
                                        <div class="data_div" name='email'><?php echo $USER["Email"]?></div>
                                    </div>
                                    
                                    <div class="data_wrapper">
                                        <label class="data_label">Phone number</label>
                                        <div class="data_div" name='phone'><?php echo $USER["Phone_Number"]?></div>
                                    </div>
                            ...
                            <div class="profile_right_content">
                                <div class="data_wrapper_static">
                                    ...
                                    <div class="data_div_static"><?php echo $USER["Company_ID"]?></div>
                                </div>
                                
                                <div class="data_wrapper_static">
                                    <label class="data_label">Company number</label>
                                    <div class="data_div_static"><?php echo $USER["Company_Number"]?></div>
                                </div>

                                <div class="data_wrapper_static">
                                    <label class="data_label">Profile password</label>
                                    <a href="<?php echo URLROOT;?>/User/PasswordUpdate" class="update_password">Change profile password</a>
                                </div>
                            </div>
                        </div>
                    </div>
