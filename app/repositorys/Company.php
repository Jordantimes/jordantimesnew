...
//                 $Data["descriptionAr"],
            ...
            $table = "trips";
            $columns = "company,name,name_ar,start_location,end_location,start_date,end_date,days,nights,description,price,breakfast,breakfast_price,lunch,lunch_price,dinner,dinner_price,images,created_at,updated_at,is_deleted";
